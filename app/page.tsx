      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
            The easiest way for university students to share rides and save
            money
          </p>
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="pt-6">
                ...
                <div className="mt-2 text-base text-gray-500">
                  Post your trip details and available seats
                </div>
              </div>
              <div className="pt-6">
                <div className="flex justify-center">
                ...
                <div className="mt-2 text-base text-gray-500">
                  Share your ride link to your classmates on WhatsApp, Slack etc.
                </div>
              </div>
              <div className="pt-6">
                <div className="flex justify-center">
                ...
                <div className="mt-2 text-base text-gray-500">
                  Review and accept interested passengers
                </div>
              </div>
            </div>
          </div>
